...
oxy_percentage <- dcast(oxy_area_pass, IndicatorID + UnitID + Period + Name + Code + Parameters + Units + DepthMin + DepthMax + Metric + UnitArea + N_GRIDS +GridArea ~ EQRS_pass_fail, value.var = "GridArea")
#replace NAs with 0s

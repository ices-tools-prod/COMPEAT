...
# Define paths
inputPath <- file.path("data", assessmentPeriod,"input")
outputPath <- file.path("data", assessmentPeriod,"output")
...
} else if (assessmentPeriod == "COMP 5 (1990-2000)") {
  urls <- c("https://icesoceanography.blob.core.windows.net/compeat/AssessmentUnits.zip",
...
} else if (assessmentPeriod == "COMP 5 (2001-2006)") {
  urls <- c("https://icesoceanography.blob.core.windows.net/compeat/AssessmentUnits.zip",
...
} else if (assessmentPeriod == "COMP 5 (2006-2014)") {
  urls <- c("https://icesoceanography.blob.core.windows.net/compeat/AssessmentUnits.zip",
...
} else if (assessmentPeriod == "COMP 5 (2015-2020)") {
  urls <- c("https://icesoceanography.blob.core.windows.net/compeat/AssessmentUnits.zip",
...
} else if (assessmentPeriod == "COMP 5 (2021-2026)") {
  urls <- c("https://icesoceanography.blob.core.windows.net/compeat/AssessmentUnits.zip",
...
indicatorUnitResults <- as.data.table(read_excel(configurationFile, sheet = "IndicatorUnitResults", col_types = "numeric")) %>% setkey(IndicatorID, UnitID)

...
wk5 <- read.csv("../Output_chl_weighted/2015-2020-HS1/Assessment_Indicator.csv")

#Read in O2Sat results

sat <- read.csv("../Output_chl_weighted/oxy_plots/O2SAT/O2SAT_COMP4.csv")

conc <- read.csv("../Output_chl_weighted/oxy_plots/O2_COMP4.csv")
